prompt_extraction_assistant = """Objective: The main goal is to meticulously gather information from a dialogue with the user and organize this data into a clear, structured knowledge graph.
...
prompt_refining_items_assistant = """You will be provided with list of existing triplets and list of new triplets. Triplets are in the following format: "subject, relation, object".
